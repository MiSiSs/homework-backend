...
public class PersonaController {
	...
	@PostMapping
	public ResponseEntity<Void> registrar(@Valid @RequestBody Persona person) throws Exception{
		Persona obj = service.registrar(person);
	...
	@PutMapping
	public ResponseEntity<Persona> modificar(@Valid @RequestBody Persona person) throws Exception{
		Persona obj = service.modificar(person);
		return new ResponseEntity<Persona>(obj, HttpStatus.OK);
	}
