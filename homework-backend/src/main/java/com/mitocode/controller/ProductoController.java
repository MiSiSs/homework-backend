...
public class ProductoController {
	...
	@PostMapping
	public ResponseEntity<Void> registrar(@Valid @RequestBody Producto product) throws Exception{
		Producto obj = service.registrar(product);
	...
	@PutMapping
	public ResponseEntity<Producto> modificar(@Valid @RequestBody Producto product) throws Exception{
		Producto obj = service.modificar(product);
		return new ResponseEntity<Producto>(obj, HttpStatus.OK);
	}
